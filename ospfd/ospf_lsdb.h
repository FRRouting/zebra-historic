...
struct ospf_lsa *ospf_lsdb_lookup(struct ospf_lsdb *, struct in_addr, struct in_addr);
struct ospf_lsa *ospf_lsdb_lookup_by_id(struct ospf_lsdb *, struct in_addr);
struct ospf_lsa *ospf_lsdb_lookup_by_header(struct ospf_lsdb *, struct ospf_lsa *);
struct ospf_lsa *ospf_lsdb_iterator( struct ospf_lsdb *, void *, int, int (*callback)(struct ospf_lsa *, void *, int));
